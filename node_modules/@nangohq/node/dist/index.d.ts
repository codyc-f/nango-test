...
import type { ApiKeyCredentials, AppCredentials, AppStoreCredentials, BasicApiCredentials, CustomCredentials, OAuth2ClientCredentials, TbaCredentials, TableauCredentials, UnauthCredentials } from '@nangohq/types';
...
export declare class Nango {
     ...
     * @param forceRefresh - Optional. When set to true, this obtains a new access token from the provider before the current token has expired
     */
    getToken(providerConfigKey: string, connectionId: string, forceRefresh?: boolean): Promise<string | OAuth1Token | BasicApiCredentials | ApiKeyCredentials | AppCredentials | OAuth2ClientCredentials | AppStoreCredentials | UnauthCredentials | CustomCredentials | TbaCredentials | TableauCredentials>;
    /**
